export function Header() {
  return (
    <header className="sm:flex sm:justify-between sm:items-center sm:pr-8 shadow-sm shadow-gray-400 z-10 relative">
      <h1 className="flex px-3 py-1 text-[40px] text-[#024D78] font-title leading-none pt-4 cursor-pointer">
        KS
      </h1>
      <nav>
        <ul className="bg-[#272727] flex justify-between text-white font-title sm:bg-white sm:text-[#024d78] sm:gap-4">
          <a
            href="#"
